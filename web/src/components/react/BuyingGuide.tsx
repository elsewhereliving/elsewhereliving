...
const LEGAL_GUIDES: Guide[] = [
  {
    ...
    secure: {
      ...
      layers: [
        ...
        { n: "03", t: "Sap-Ing-Sith (ทรัพย์อิงสิทธิ) — a registered right you can trade and pass on", b: "A registered right over the property, introduced in 2019 and recorded at the Land Office. Unlike a plain lease, Sap-Ing-Sith ==can be freely transferred, mortgaged and passed to your heirs== within its term, and it survives a sale of the land underneath. Its one limit is duration — a single 30-year term, with any extension negotiated rather than automatic. It's still a relatively new instrument, so availability depends on the project and the landowner's willingness to grant it." },
        { n: "04", t: "Usufruct — the right to use and profit", b: "Registered for your lifetime, giving you the legal right to use and enjoy the property — including receiving the income it generates, where permitted. Where a lease has a hard 30-year edge, ==a usufruct runs as long as you do==." },
      ],
    ...
    process: [
      { t: "Reserve", b: "A short reservation agreement and a modest deposit take the property off the market while diligence runs. Under the reservation agreement, the deposit is refundable if due diligence turns up material title issues." },
